...
class DeployManager
  ...
  def deploy_to_gh_pages
    ...
    unless system('git show-ref --quiet refs/heads/gh-pages')
      ...
      system('git checkout --orphan gh-pages') || abort('Error while creating gh-pages branch.')
    ...
    system('git commit -m "Update gh-pages with new deployment"') || abort('Error while committing changes.')
